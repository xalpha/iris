 ...
 *                  great library to detect random dot markers for which
...
UCHIYAMARKERSFinder::UCHIYAMARKERSFinder() :
    Finder(),
...
void UCHIYAMARKERSFinder::configure( const std::string& patternDescriptor )
{
...
void UCHIYAMARKERSFinder::setAdaptiveExtract( bool val )
{
    m_adaptiveExtract = val;
}


void UCHIYAMARKERSFinder::setMinPoints( size_t minPoints )
{
...
bool UCHIYAMARKERSFinder::find( Pose_d& pose )
{
